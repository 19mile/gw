...
function initOutlineMove() {
    ...
    $("#outline").on("touchstart", function(event) {
        event.preventDefault();
        startABX = event.changedTouches[0].pageY - $("#outline").get(0).offsetTop;
    }).on("touchmove", function() {
        way = event.touches[0].pageY - startABX - $("#outline").get(0).offsetTop;
        event.preventDefault();
